class PokemonModel {
  ...
  static List<PokemonModel> samples = [
    PokemonModel(
        name: '피카츄',
        imageAddress: 'assets/images/pikachu.png',
        indexNum: 25,
        skills: [
    ...
    PokemonModel(
        name: '이상해씨',
        imageAddress: 'assets/images/bulbasaur.png',
        indexNum: 1,
        skills: [
    ...
    PokemonModel(
        name: '파이리',
        imageAddress: 'assets/images/charmander.png',
        indexNum: 4,
        skills: [
    ...
    PokemonModel(
        name: '꼬부기',
        imageAddress: 'assets/images/squirtle.png',
        indexNum: 7,
        skills: [
          SkillModel(name: '몸통박치기', damage: 35, pp: 35, learningLevel: 1),
    ...
    PokemonModel(
        name: '갸라도스',
        imageAddress: 'assets/images/gyarados.png',
        indexNum: 130,
        skills: [
    ...
    PokemonModel(
        name: '망나뇽',
        imageAddress: 'assets/images/dragonite.png',
        indexNum: 149,
        skills: [
    ...
    PokemonModel(
        name: '잠만보',
        imageAddress: 'assets/images/snorlax.png',
        indexNum: 143,
        skills: [
    ...
    PokemonModel(
        name: '팬텀',
        imageAddress: 'assets/images/haunter.png',
        indexNum: 94,
        skills: [
    ...
    PokemonModel(
        name: '전룡',
        imageAddress: 'assets/images/ampharos.png',
        indexNum: 181,
        skills: [
